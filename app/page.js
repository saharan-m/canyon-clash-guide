        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center mb-4 sm:mb-6 md:mb-8 lg:mb-12 animate-slideInDown px-1">
            <div className="inline-block mb-2 sm:mb-3 px-3 sm:px-4 py-1 sm:py-1.5 rounded-full glass-light border border-blue-400/30">
              <p className="text-blue-500 dark:text-blue-300 text-[9px] sm:text-xs md:text-sm font-semibold">🏜️ Whiteout Survival Event</p>
            </div>
            
            <h1 className="heading-1 mb-2 sm:mb-3 md:mb-4 leading-tight px-1">
          ...
          <div className="flex flex-col sm:flex-row gap-2 sm:gap-3 md:gap-4 mb-4 sm:mb-6 md:mb-8 lg:mb-12 justify-center px-1">
            <Link
              href="#select-team"
              className="group relative inline-flex items-center justify-center gap-2 px-6 py-3 sm:px-8 sm:py-3.5 rounded-xl font-semibold text-white bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-500 hover:to-purple-500 transition-all duration-200 shadow-lg hover:shadow-xl transform hover:scale-105 active:scale-95 w-full sm:w-auto text-center overflow-hidden"
            >
            ...
            <Link
              href="#all-paths-map"
              className="group relative inline-flex items-center justify-center gap-2 px-6 py-3 sm:px-8 sm:py-3.5 rounded-xl font-semibold text-white bg-gradient-to-r from-cyan-600 to-blue-600 hover:from-cyan-500 hover:to-blue-500 transition-all duration-200 shadow-lg hover:shadow-xl transform hover:scale-105 active:scale-95 w-full sm:w-auto text-center overflow-hidden"
            >
              <span className="relative z-10 flex items-center gap-2">
                <svg className="w-4 h-4 sm:w-5 sm:h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
